...
template = """
You are an assistant tasked with answering questions based on Jira issues.
...
def get_answer(question):
    db = Chroma(persist_directory="./slack_db", embedding_function=OpenAIEmbeddings(openai_api_key=openai_api_key))
